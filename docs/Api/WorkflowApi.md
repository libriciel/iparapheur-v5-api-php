...
[**requestSecureMail()**](WorkflowApi.md#requestSecureMail) | **PUT** /api/standard/v1/tenant/{tenantId}/desk/{deskId}/folder/{folderId}/task/{taskId}/secure_mail | Secure mail
...
try {
    ...
    echo 'Exception when calling WorkflowApi->requestSecureMail: ', $e->getMessage(), PHP_EOL;
}
```
