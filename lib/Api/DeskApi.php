...
class DeskApi
{
     ...
     * @return \Libriciel\IparapheurV5\Client\Model\StandardApiPageImplDeskRepresentation|\Libriciel\IparapheurV5\Client\Model\ErrorResponse|\Libriciel\IparapheurV5\Client\Model\ErrorResponse|\Libriciel\IparapheurV5\Client\Model\ErrorResponse|\Libriciel\IparapheurV5\Client\Model\ErrorResponse
     */
    public function listUserDesks($tenant_id, $page = 0, $size = 10, $sort = null)
    {
        list($response) = $this->listUserDesksWithHttpInfo($tenant_id, $page, $size, $sort);
        return $response;
    }

    /**
     * Operation listUserDesksWithHttpInfo
     *
     * List desks attached to the current user
     *
     * @param  string $tenant_id Tenant id (required)
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Libriciel\IparapheurV5\Client\Model\StandardApiPageImplDeskRepresentation',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return Promise
     */
    public function listUserDesksAsync($tenant_id, $page = 0, $size = 10, $sort = null)
    {
        return $this->listUserDesksAsyncWithHttpInfo($tenant_id, $page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listUserDesksAsyncWithHttpInfo
     *
     * List desks attached to the current user
     *
     * @param  string $tenant_id Tenant id (required)
    ...
    {
        $returnType = '\Libriciel\IparapheurV5\Client\Model\StandardApiPageImplDeskRepresentation';
        $request = $this->listUserDesksRequest($tenant_id, $page, $size, $sort);
    ...
    /**
     * Create request for operation 'listUserDesks'
     *
     * @param  string $tenant_id Tenant id (required)
     * @param  int $page Zero-based page index (0..N) (optional, default to 0)
     * @param  int $size The size of the page to be returned (optional, default to 10)
     ...
     */
    public function listUserDesksRequest($tenant_id, $page = 0, $size = 10, $sort = null)
    {
        // verify the required parameter 'tenant_id' is set
        if ($tenant_id === null || (is_array($tenant_id) && count($tenant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tenant_id when calling listUserDesks'
            );
        }
        if ($page !== null && $page < 0) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling DeskApi.listUserDesks, must be bigger than or equal to 0.');
        }

        if ($size !== null && $size < 1) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling DeskApi.listUserDesks, must be bigger than or equal to 1.');
        }


        $resourcePath = '/api/standard/v1/tenant/{tenantId}/desk';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
