 ...
 */
class DeskRepresentation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeskRepresentation';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DeskRepresentation., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 2)) {
