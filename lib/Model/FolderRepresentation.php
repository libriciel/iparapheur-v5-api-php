...
/**
 * FolderRepresentation Class Doc Comment
 *
 * @category Class
 * @package  Libriciel\IparapheurV5\Client
 * @author   OpenAPI Generator team
 ...
 */
class FolderRepresentation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FolderRepresentation';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FolderRepresentation., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 2)) {
