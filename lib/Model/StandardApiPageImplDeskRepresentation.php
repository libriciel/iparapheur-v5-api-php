 ...
 */
class StandardApiPageImplDeskRepresentation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StandardApiPageImplDeskRepresentation';
